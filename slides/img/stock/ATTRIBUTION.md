...
All photos sourced from [Unsplash](https://unsplash.com) under the [Unsplash License](https://unsplash.com/license) (free to use, attribution appreciated).

| File | Description | Source |
|------|-------------|--------|
| `ai-displacement.jpg` | A close-up of a circuit board | [Unsplash](https://unsplash.com/photos/a-close-up-of-a-circuit-board-6BCgNl-UY6A) |
| `energy-motivation.jpg` | Light bulb | [Unsplash](https://unsplash.com/photos/light-bulb-WsEbnsnKbUE) |
| `how-did-we-get-here.jpg` | Aerial shot of road surrounded by green trees | [Unsplash](https://unsplash.com/photos/aerial-shot-of-road-surrounded-by-green-trees-qzgN45hseN0) |
| `kata-meetup.jpg` | Man wearing gray polo shirt beside dry-erase board | [Unsplash](https://unsplash.com/photos/man-wearing-gray-polo-shirt-beside-dry-erase-board-3V8xo5Gbusk) |
| `lock-in.jpg` | Gray steel chain locked on gate | [Unsplash](https://unsplash.com/photos/gray-steel-chain-locked-on-gate-bqGBbLq_yfc) |
| `opportunity-loss.jpg` | Railway between tall trees | [Unsplash](https://unsplash.com/photos/railway-between-tall-trees-m5HKU-TbGaA) |
| `opportunity-seedling.jpg` | Green plants on soil | [Unsplash](https://unsplash.com/photos/green-plants-on-soil-ruQHpukrN7c) |
